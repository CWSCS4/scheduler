...
namespace
{
  void printUsage(std::ostream &out, const char *programName)
  {
    out << "Usage: " << programName << " OPTION...\n"
        ...
        << "  -r, --seed <seed>           Specifies a seed for the psuedo-random\n"
        << "                              number generator.  If no seed is \n"
        << "                              specified, the number of seconds since\n"
        << "                              the epoch is used.\n"
...
int main(int argc, char **argv)
{
  ...
  generateInitialSchedule(state, spec);

  writeState(std::cout, state);
